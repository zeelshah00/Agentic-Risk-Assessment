...
resource "google_artifact_registry_repository" "repo" {
  ...
  repository_id = "bigid-agentic-app-repo-dev"
  format        = "DOCKER"
...
resource "google_service_account" "default" {
  project      = var.gcp_project_id
  account_id   = "bigid-agentic-app-sa-dev"
  display_name = "BigID Agentic App Service Account - Dev"
}
...
resource "google_firestore_database" "usage_database" {
  project     = var.gcp_project_id
  name        = "bigid-agentic-app-usage-dev"
